...
const Index = memo(() => {
  ...
  return (
    <div className={`min-h-screen ${isMobile ? 'bg-cover bg-center bg-no-repeat' : ''} pb-20 md:pb-0`}
            ...
            <div className={`max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 ${isMobile ? 'pt-6 pb-12' : 'py-16'} relative z-10`}>
              <div className="text-center">
                ...
                <div className={`flex justify-center ${isMobile ? 'mb-4' : 'mb-8'}`}>
                  {isMobile ? (
                    <img src="/lovable-uploads/bandon-dunes-logo.png" alt="Bandon Dunes Logo" className="object-contain h-24 w-auto" />
                  ) : (
