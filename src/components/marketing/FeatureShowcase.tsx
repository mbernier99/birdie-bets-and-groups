    ...
    <div className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Everything You Need for Golf Tournaments</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            From casual rounds with friends to organized tournaments, BetLoopr provides all the tools you need.
          </p>
        </div>
